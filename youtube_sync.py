...
class YouTubeSync:
    ...
    def get_new_videos(self, videos: List[Dict]) -> List[Dict]:
        ...
        existing_video_ids = set(
            doc['video_id'] 
            for doc in self.videos_collection.find({}, {'video_id': 1})
        )
    ...
    def stream_to_s3(self, video: Dict) -> Optional[str]:
        ...
        try:
            ...
            yt = YouTube(f"https://www.youtube.com/watch?v={video['video_id']}", on_progress_callback=on_progress)
            ...
            try:
                ...
                logger.info(f"Streaming {video['title']} {video['video_id']} to s3 bucket")
                ...
                logger.info(f"Completed successfully Streaming {video['title']} {video['video_id']} to s3 bucket")
